...
class MuseTalkCupAudio:
    ...
    def run(self,audio_path,start,end):
        ...
        t=int(time.time())
        sound.export(f'{comfy_path}/output/video/{t}.wav', format="wav")
        return (f'{comfy_path}/output/video/{t}.wav',)
...
class MuseTalkRun:
    ...
    def run(self, video_path,audio_path,bbox_shift,batch_size):
        ...
        parser.add_argument("--result_dir", default='{comfy_path}/output/video', help="path to output")
